...
@Component({
  selector: 'confirm-buyback-offer-price-modal',
  templateUrl: './confirm-buyback-offer-price-modal.component.html',
  styleUrls: ['./confirm-buyback-offer-price-modal.component.scss'],
})
export class ConfirmBuybackOfferPriceModal implements OnInit, OnChanges {
