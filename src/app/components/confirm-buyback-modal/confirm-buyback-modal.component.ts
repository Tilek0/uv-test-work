...
@Component({
  selector: 'confirm-buyback-modal',
  templateUrl: './confirm-buyback-modal.component.html',
  styleUrls: ['./confirm-buyback-modal.component.scss'],
})
export class ConfirmBuybackModal implements OnInit, OnChanges {
