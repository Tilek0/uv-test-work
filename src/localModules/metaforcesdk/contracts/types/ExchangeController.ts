...
export interface ExchangeControllerInterface extends utils.Interface {
  functions: {
...
export interface ExchangeController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeControllerInterface;
